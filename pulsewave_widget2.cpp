...
void pulsewave_widget2::setHtmlPages()
{
    ...
    m_pulsewave_widget->load(QUrl::fromLocalFile(QString("C:/DAS_Metro/PAGE/tpl03/PulseWaveDisplay.html")));
...
void pulsewave_widget2::FlashWave()
{
    ...
    memcpy(PulsedataHEX,udp_recv->GetPack_HEX_Display(),sizeof(char)*sizeoPulsedata);
